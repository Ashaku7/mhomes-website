  ...
  return (
    <div className="min-h-screen bg-background relative overflow-x-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(rgba(107,63,42,0.12) 1px, transparent 1px), linear-gradient(90deg, rgba(107,63,42,0.12) 1px, transparent 1px)",
            ...
            <div className="hidden lg:flex items-center space-x-1">
              {[
                ...
                >
                  ...
                  <span
                    className={`absolute bottom-0 left-0 w-full h-0.5 bg-[#6B3F2A] transition-transform duration-300 origin-left ${item.name === "Reviews" ? "scale-x-100" : "scale-x-0 group-hover:scale-x-100"}`}
                  />
                </Link>
              ))}
            </div>
          ...
          >
            <div className="container mx-auto px-4 py-4 space-y-3">
              ...
              <Link
                href="/reviews"
                onClick={() => setIsMenuOpen(false)}
                className="block luxury-text text-[#6B3F2A] transition-colors font-semibold py-2 px-3 rounded-lg bg-primary/5"
              >
                Reviews
              </Link>
              <Link
      ...
      <main className="container mx-auto max-w-7xl px-4 pt-32 pb-10">
        ...
        >
          ...
          <p className="luxury-text text-lg md:text-xl text-[#5F4B40] max-w-3xl mx-auto leading-[1.8]">
            Honest words from our guests, thoughtfully presented in a setting
            that reflects the MHOMES experience.
          </p>
        </motion.section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-10 items-start">
          ...
          >
            <div className="sticky top-28 rounded-3xl border border-accent/25 bg-[linear-gradient(160deg,rgba(255,255,255,0.88),rgba(255,255,255,0.7))] p-8 shadow-[0_22px_60px_rgba(107,63,42,0.14)] backdrop-blur-sm">
              <h2 className="luxury-heading text-3xl font-medium text-[#3A271F] mb-5">
                Share Your Experience
              </h2>
              <p className="luxury-text text-[#5F4B40] leading-[1.8] mb-6">
                Stayed with us recently? Tell future guests about your time at
                MHOMES and help us continue elevating every stay.
              </p>
              <div className="rounded-2xl border border-accent/30 bg-accent/10 px-5 py-4 mb-6">
                <p className="luxury-label text-[11px] tracking-[0.2em] text-[#5A3728] mb-2">
                  Trusted Guest Voice
                </p>
                <p className="text-sm text-[#5F4B40]">
                  Your Google review supports other travelers and helps us keep
                  our standards exceptional.
                </p>
              </div>
              <motion.a
              ...
              <p className="mt-3 text-center text-xs text-[#6A594F]">
          ...
          >
            <div className="mb-6 rounded-2xl border border-accent/20 bg-white/70 px-5 py-4 shadow-sm backdrop-blur-sm">
              <h3 className="luxury-heading text-2xl text-[#3A271F]">
                All Reviews
              </h3>
            </div>
            ...
            <div className="space-y-4">
              {isLoading ? (
                ...
                <div className="rounded-2xl border border-accent/20 bg-white/70 px-8 py-14 text-center shadow-sm backdrop-blur-sm">
                  <p className="luxury-text text-lg text-[#5F4B40]">
                    No reviews available yet.
                  </p>
                  <p className="luxury-text text-sm text-[#6A594F] mt-2">
                      ...
                      <CardContent className="p-6 md:p-7">
                        <div className="flex items-start justify-between gap-4 mb-4">
                          <div className="flex items-start gap-3 md:gap-4">
                            ...
                            <div>
                              <h4 className="luxury-heading text-base md:text-lg text-[#3A271F]">
                                {review.name}
                              </h4>
                          ...
                          <div className="text-right shrink-0">
                            <p className="luxury-text text-xs text-[#6A594F] mb-1.5">
                              {review.date}
                            </p>
                        ...
                        <p className="luxury-text text-[#4A3930] leading-[1.8]">
                          {review.text}
                        </p>
                      </CardContent>
                    </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 py-16">
            ...
            >
              ...
              <p className="luxury-text text-white/80 text-sm leading-relaxed mb-6 pl-8">
                Experience luxury redefined in the heart of Madurai. Premium
                accommodations designed for unforgettable memories.
              </p>
            </motion.div>
            ...
            >
              <h3 className="luxury-heading text-lg font-bold text-white mb-8 uppercase tracking-wider">
                Explore
              </h3>
            ...
            >
              ...
              <div className="space-y-6">
                <div>
                  <p className="luxury-text text-white/70 text-xs uppercase tracking-wide mb-2">
                    Address
                  </p>
